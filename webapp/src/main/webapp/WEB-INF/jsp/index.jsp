...
<div class="site-wrap">
    ...
    <div class="main-wrap " id="section-home">
        ...
        <div class="cover_1 overlay bg-slant-white bg-light">
            <div class="img_bg" style="background-image: url(<c:url value="/resources/images/slider-1.jpg"/>);" data-stellar-background-ratio="0.5">
                <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="ftco-46">
                        <div class="ftco-46-row d-flex flex-column flex-lg-row">
                            <div class="ftco-46-image" style="background-image: url(<c:url value="/resources/images/img_1.jpg"/>);"></div>
                            ...
                            <div class="ftco-46-image" style="background-image: url(<c:url value="/resources/images/img_2.jpg"/>);"></div>
                        </div>
                        ...
                        <div class="ftco-46-row d-flex flex-column flex-lg-row">
                            ...
                            <div class="ftco-46-image" style="background-image: url(<c:url value="/resources/images/img_3.jpg"/>);"></div>
        ...
        <div class="section bg-white pt-2 pb-2 text-center" data-aos="fade">
            <p><img src="<c:url value="/resources/images/bg_hero.png"/>" alt="Free Website Template for Restaurants by Free-Template.co" class="img-fluid"></p>
        </div> <!-- .section -->
                ...
                <div class="row">
                        ...
                        <div class="ftco-38">
                            <div class="ftco-38-img">
                                <div class="ftco-38-header">
                                    <img src="<c:url value="/resources/images/chef_1.jpg"/>" alt="Free Website Template for Restaurants by Free-Template.co">
                    ...
                    <div class="col-md-6 pl-md-5 text-center mb-5">
                        <div class="ftco-38">
                            <div class="ftco-38-img">
                                <div class="ftco-38-header">
                                    <img src="<c:url value="/resources/images/chef_2.jpg"/>" alt="Free Website Template for Restaurants by Free-Template.co">
                            ...
                            <div class="tab-pane fade show active" id="pills-breakfast" role="tabpanel" aria-labelledby="pills-breakfast-tab">
                                <div class="d-block d-md-flex menu-food-item">
                                    ...
                                    <div class="text order-1 mb-3">
                                        <img src="<c:url value="/resources/images/img_1.jpg"/>" alt="Free Website Template for Restaurants by Free-Template.co">
                                ...
                                <div class="d-block d-md-flex menu-food-item">
                                    <div class="text order-1 mb-3">
                                        <img src="<c:url value="/resources/images/img_2.jpg"/>" alt="Free Website Template for Restaurants by Free-Template.co">
                                ...
                                <div class="d-block d-md-flex menu-food-item">
                                    <div class="text order-1 mb-3">
                                        <img src="<c:url value="/resources/images/img_3.jpg"/>" alt="Free Website Template for Restaurants by Free-Template.co">
                        ...
                        <div class="owl-carousel home-slider-loop-false">
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<c:url value="/resources/images/person_1.jpg"/>" alt="Image placeholder" class="mb-3">
                                        <h4>Maxim Smith</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<c:url value="/resources/images/person_2.jpg"/>" alt="Image placeholder" class="mb-3">
                                        <h4>Geert Green</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>
                            ...
                            <div class="item">
                                <blockquote class="testimonial">
                                    ...
                                    <div class="author">
                                        <img src="<c:url value="/resources/images/person_3.jpg"/>" alt="Image placeholder" class="mb-3">
                                        <h4>Dennis Roman</h4>
                                        <p>CEO, Founder</p>
                                    </div>
                                </blockquote>

...
using ApiCrawlerTuTV.Model.IMDb;
using ApiCrawlerTuTV.Model.TheTvDb;
...
namespace ApiCrawlerTuTV {
    public class TheTvDbCrawler {
        ...
        public TheTvDbCrawler(string TvDbApiKey, string TvDbUserName, string TvDbUserKey, string IMDbApiKey) {
